...
def prep_env():
    ...
    ###
    parser.add_argument('--data_path', type=str, default='./kddcup22-sdwpf-evaluation/data/', help='Path to the data file')
    ...
    parser.add_argument('--hidden_size', type=float, default=4, help='hidden channel of module')
    parser.add_argument('--num_stacks', type=int, default=1, help='1 stack or 2 stacks')
    ...
    settings = {        
        ...
        "positionalEcoding": args.positionalEcoding,
